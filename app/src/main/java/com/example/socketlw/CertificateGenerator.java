...
//        // 证书信息
//        // 发行者issuer
//        org.bouncycastle.asn1.x500.X500Name issuer = new org.bouncycastle.asn1.x500.X500Name("CN=Issuer, O=My Organization");
//        // 主体subject
//        org.bouncycastle.asn1.x500.X500Name subject = new X500Name("CN=Subject, O=My Organization");
...
//
//        // 构建算法标识符，使用 SM2 OID
//        org.bouncycastle.asn1.ASN1ObjectIdentifier sm2Oid = new ASN1ObjectIdentifier(GMObjectIdentifiers.sm2p256v1.toString()); // SM2 OID
//        org.bouncycastle.asn1.x509.AlgorithmIdentifier algorithmIdentifier = new AlgorithmIdentifier(sm2Oid);
//
...
// 添加 BouncyCastle 提供程序
    ...
    public static  X509Certificate certRecover(String encodeCert)throws Exception{
        byte[] encodeCertB= Hex.decode(encodeCert);
        CertificateFactory certificateFactory = CertificateFactory.getInstance("X.509");
        X509Certificate certificateRecover = (X509Certificate) certificateFactory.generateCertificate(new ByteArrayInputStream(encodeCertB));
        return certificateRecover;
    ...
    public static String verifyCert(String encodecert)throws Exception{
       ...
       // cert.verify(PkCA,"BC");
        ...
        System.out.println("cert.getTBSCertificate():"+cert.getTBSCertificate());
